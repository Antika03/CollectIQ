...
<title><?php echo $__env->yieldContent('title', 'Dashboard'); ?> — PTP Collection Intelligence</title>
...
<div class="sidebar" id="sidebarEl">
    <div class="sidebar-header">
        <a href="<?php echo e(url('/')); ?>" style="display:block; text-decoration:none;">
            <img src="<?php echo e(asset('images/telkom-logo.png')); ?>" alt="Telkom Indonesia" style="height:48px; width:auto; object-fit:contain; display:block; margin:0 auto;">
        </a>
    </div>
    ...
    <div class="menu-section">
        ...
        <div class="menu">
            ...
            <a href="<?php echo e(url('/customers')); ?>" class="<?php echo e(request()->is('customers*') ? 'active' : ''); ?>">
                <i class="bi bi-people-fill"></i> Customers
            </a>
            <a href="<?php echo e(url('/visits')); ?>" class="<?php echo e(request()->is('visits*') ? 'active' : ''); ?>">
    ...
    <div class="menu-section">
        ...
        <div class="menu">
            <a href="<?php echo e(url('/ptp-monitoring')); ?>" class="<?php echo e(request()->is('ptp-monitoring*') ? 'active' : ''); ?>">
                <i class="bi bi-cash-coin"></i> PTP Monitoring
            </a>
            <a href="<?php echo e(url('/risk-score')); ?>" class="<?php echo e(request()->is('risk-score*') ? 'active' : ''); ?>">
                <i class="bi bi-shield-exclamation"></i> Risk Score
            </a>
            <a href="<?php echo e(url('/piutang')); ?>" class="<?php echo e(request()->is('piutang*') ? 'active' : ''); ?>">
    ...
    <div class="menu-section">
        ...
        <div class="menu">
            <a href="<?php echo e(url('/c3mr/hasil-caring')); ?>" class="<?php echo e(request()->is('c3mr/hasil-caring*') ? 'active' : ''); ?>">
                <i class="bi bi-telephone-fill"></i> Hasil Caring OBC
            </a>
            <a href="<?php echo e(url('/c3mr/performance')); ?>" class="<?php echo e(request()->is('c3mr/performance*') ? 'active' : ''); ?>">
                <i class="bi bi-graph-up-arrow"></i> Churn Risk & Witel
            </a>
            <a href="<?php echo e(url('/c3mr/sync')); ?>" class="<?php echo e(request()->is('c3mr/sync*') ? 'active' : ''); ?>">
    ...
    <div class="menu-section">
        ...
        <div class="menu">
            <a href="<?php echo e(url('/ar-agents')); ?>" class="<?php echo e(request()->is('ar-agents*') ? 'active' : ''); ?>">
    ...
    <div class="topbar">
        <div class="d-flex align-items-center gap-2" style="min-width:0;">
            ...
            <div style="min-width:0;">
                ...
                <div class="page-subtitle"><?php echo $__env->yieldContent('subtitle', 'PT Telekomunikasi Indonesia'); ?></div>
            </div>
        </div>
        ...
        <div class="topbar-search">
            <form action="<?php echo e(url('/search')); ?>" method="GET">
                <input id="topbar-search-input" type="text" name="q" value="<?php echo e(request('q')); ?>" class="topbar-search-input" placeholder="Cari pelanggan, no internet, AR Agent..." autocomplete="off">
        ...
        <div class="topbar-right">
            <div class="topbar-badge">
                <i class="bi bi-calendar3"></i> <?php echo e(now()->translatedFormat('d F Y')); ?>
...
</html><?php /**PATH D:\Projek Telkom Reva\ptp-intelligence-dashboard\resources\views/layouts/app.blade.php ENDPATH**/ ?>