<?php $__env->startSection('title', 'Visit Monitoring'); ?>
<?php $__env->startSection('subtitle', 'Collection Visit Monitoring — AR Team'); ?>
...
<div class="vm-kpi-grid">
    ...
    <div class="vm-kpi-card accent-red">
        ...
        <div class="vm-kpi-value"><?php echo e(number_format($totalVisit)); ?></div>
    ...
    <div class="vm-kpi-card accent-blue">
        ...
        <div class="vm-kpi-value"><?php echo e(number_format($visitHariIni)); ?></div>
        <div class="vm-kpi-sub"><?php echo e(now()->translatedFormat('d M Y')); ?></div>
    </div>
    ...
    <div class="vm-kpi-card accent-amber">
        ...
        <div class="vm-kpi-value"><?php echo e(number_format($totalPtp)); ?></div>
        <div class="vm-kpi-sub"><?php echo e($totalVisit > 0 ? number_format($totalPtp / $totalVisit * 100, 1) : 0); ?>% dari total</div>
    </div>
    ...
    <div class="vm-kpi-card accent-green">
        ...
        <div class="vm-kpi-value"><?php echo e(number_format($contactedCount)); ?></div>
        <div class="vm-kpi-sub"><?php echo e($totalVisit > 0 ? number_format($contactedCount / $totalVisit * 100, 1) : 0); ?>% dari total</div>
    </div>
    ...
    <div class="vm-kpi-card accent-rose">
        ...
        <div class="vm-kpi-value"><?php echo e(number_format($notContactedCount)); ?></div>
        <div class="vm-kpi-sub"><?php echo e($totalVisit > 0 ? number_format($notContactedCount / $totalVisit * 100, 1) : 0); ?>% dari total</div>
    </div>
    ...
    <div class="vm-kpi-card accent-slate">
        ...
        <div class="vm-kpi-value"><?php echo e(number_format($ptpHariIni)); ?></div>
        <div class="vm-kpi-sub"><?php echo e($visitHariIni > 0 ? number_format($ptpHariIni / $visitHariIni * 100, 1) : 0); ?>% dari hari ini</div>
    </div>
...
<div class="vm-filter-panel">
    <div style="display:flex; align-items:center; justify-content:space-between; gap:12px; flex-wrap:wrap;">
        ...
        <?php if(request()->anyFilled(['date_from','date_to','ar_agent_id','hasil_visit','kategori_visit','is_ptp','status_contact','search'])): ?>
        ...
        <div class="vm-filter-grid">
            ...
            <div>
                ...
                <select name="hasil_visit" class="form-select form-select-sm">
                    ...
                    <?php $__currentLoopData = $hasilVisitOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hasil): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($hasil); ?>" <?php echo e(request('hasil_visit') == $hasil ? 'selected' : ''); ?>>
                        <?php echo e($hasil); ?>
            ...
            <div>
                ...
                <select name="is_ptp" class="form-select form-select-sm">
                    ...
                    <option value="1" <?php echo e(request('is_ptp') === '1' ? 'selected' : ''); ?>>PTP</option>
                    <option value="0" <?php echo e(request('is_ptp') === '0' ? 'selected' : ''); ?>>Non-PTP</option>
                </select>
            </div>
        </div>
        ...
        <div class="vm-filter-row2">
            <div>
                ...
                <div style="position:relative;">
                    ...
                    <input type="text" name="search" class="form-control form-control-sm" placeholder="Nama pelanggan / nomor internet..."
                        value="<?php echo e(request('search')); ?>" style="padding-left:30px;">
                </div>
            </div>
            <div>
                ...
                <select name="kategori_visit" class="form-select form-select-sm">
                    ...
                    <option value="<?php echo e($kat); ?>" <?php echo e(request('kategori_visit') == $kat ? 'selected' : ''); ?>>
                        <?php echo e($kat); ?>
            ...
            <div>
                ...
                <select name="status_contact" class="form-select form-select-sm">
                    <option value="">Semua</option>
                    <option value="contacted"     <?php echo e(request('status_contact') === 'contacted'     ? 'selected' : ''); ?>>Contacted</option>
                    <option value="not_contacted" <?php echo e(request('status_contact') === 'not_contacted' ? 'selected' : ''); ?>>Not Contacted</option>
                </select>
            </div>
    ...
    <div class="vm-table-header">
        <div>
            ...
            <div class="vm-table-count">
                <?php echo e($visits->total()); ?> data ditemukan
                <?php if($visits->total() > 0): ?>
                — halaman <?php echo e($visits->currentPage()); ?> dari <?php echo e($visits->lastPage()); ?>
        ...
        <div style="display:flex; gap:8px; flex-wrap:wrap;">
            ...
            <a href="<?php echo e('/visits/export?' . http_build_query(request()->except('page'))); ?>"
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div class="vm-photo-wrap" onclick="openPhotoModal(<?php echo e($visit->id); ?>, '<?php echo e(addslashes($visit->customer->nama_pelanggan ?? '-')); ?>', '<?php echo e($visit->drive_url); ?>')"
                             title="Lihat foto visit">
                            <img src="<?php echo e($visit->photo_preview); ?>"
                    ...
                    <td>
                        <div style="font-size:13px; font-weight:600; color:var(--ink-900);">
                            <?php echo e($visit->tanggal_input?->format('d M Y') ?? '-'); ?>

                        </div>
                        <div style="font-size:11px; color:var(--ink-400);">
                            <?php echo e($visit->tanggal_input?->diffForHumans() ?? ''); ?>
                    ...
                    <td>
                        ...
                        <div style="display:flex; align-items:center; gap:9px;">
                            <div class="avatar-circle" style="width:30px;height:30px;font-size:11px;flex-shrink:0;">
                                <?php echo e(strtoupper(substr($visit->customer->nama_pelanggan ?? '?', 0, 2))); ?>
                            ...
                            <div>
                                <div style="font-size:13px; font-weight:600; color:var(--ink-900); white-space:nowrap; max-width:180px; overflow:hidden; text-overflow:ellipsis;">
                                    <?php echo e($visit->customer->nama_pelanggan ?? '-'); ?>

                                </div>
                                <?php if($visit->customer->risk_level): ?>
                                <span class="vm-badge
                                    <?php if($visit->customer->risk_level === 'critical'): ?> vm-badge-notcon
                                    <?php elseif($visit->customer->risk_level === 'high'): ?> vm-badge-notcon
                                    <?php elseif($visit->customer->risk_level === 'medium'): ?> vm-badge-ptp
                                    <?php else: ?> vm-badge-neutral <?php endif; ?>"
                                    style="font-size:10px; padding:2px 7px; margin-top:2px;">
                                    <?php echo e(strtoupper($visit->customer->risk_level)); ?>
                    ...
                    <td>
                        <code style="font-size:12.5px; background:var(--secondary); padding:2px 7px; border-radius:5px; color:var(--ink-700);">
                            <?php echo e($visit->customer->nomor_internet ?? '-'); ?>
                    ...
                    <td>
                        <?php if($visit->hasil_visit && $visit->hasil_visit !== 'Belum Diisi' && $visit->hasil_visit !== ''): ?>
                        <span class="vm-badge vm-badge-contacted">
                            <i class="bi bi-check-circle-fill" style="font-size:10px;"></i>
                            <?php echo e(Str::limit($visit->hasil_visit, 25)); ?>
                    ...
                    <td>
                        <?php if($visit->kategori_visit): ?>
                        <span class="vm-badge vm-badge-neutral">
                            <?php echo e(Str::limit($visit->kategori_visit, 20)); ?>
                    ...
                    <td style="text-align:center;">
                        <div style="display:flex; gap:5px; justify-content:center;">
                            <button class="vm-btn-action primary" title="Detail Visit"
                                onclick="openDetailModal(<?php echo e($visit->id); ?>)">
                                <i class="bi bi-eye"></i>
                            </button>
                            <?php if($visit->customer): ?>
                            <a href="/customers/<?php echo e($visit->customer->id); ?>" class="vm-btn-action" title="Lihat Detail Profil Pelanggan" data-bs-toggle="tooltip">
    ...
    <div style="padding:16px 22px; border-top:1px solid var(--border);">
        <div class="vm-pagination">
            <div class="vm-pagination-info">
                Menampilkan <?php echo e($visits->firstItem()); ?>–<?php echo e($visits->lastItem()); ?> dari <?php echo e(number_format($visits->total())); ?> data
            </div>
            <div>
                <?php echo e($visits->links('pagination::bootstrap-5')); ?>
...
<div class="vm-chart-card" style="margin-top:16px;">
    ...
    <div class="vm-chart-sub">Total visit per agent (top <?php echo e($agentStats->count()); ?>)</div>
    <?php $maxVisit = max($agentStats->max('visits_count'), 1); ?>
    <div style="margin-top:12px;">
        ...
        <div class="vm-bar-item">
            <div class="vm-bar-name" title="<?php echo e($agent->name); ?>"><?php echo e($agent->name); ?></div>
            <div class="vm-bar-track">
                <div class="vm-bar-fill" style="width:<?php echo e(round($agent->visits_count / $maxVisit * 100)); ?>%"></div>
            </div>
            <div class="vm-bar-count"><?php echo e($agent->visits_count); ?></div>
        </div>
...
(function() {
    ...
    const visits  = <?php echo json_encode($chartVisits, 15, 512) ?>;
    const ptpData = <?php echo json_encode($chartPtp, 15, 512) ?>;
...
// ==================================================================
(function() {
    const data  = <?php echo json_encode($hasilDistribution->pluck('total'), 15, 512) ?>;
    const labels = <?php echo json_encode($hasilDistribution->pluck('hasil_visit'), 15, 512) ?>;
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Projek Telkom Reva\ptp-intelligence-dashboard\resources\views/visits/index.blade.php ENDPATH**/ ?>