...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/ar/dashboard', [ArDashboardController::class, 'index'])->name('ar.dashboard');
    ...
    */
    Route::middleware('role:admin')->group(function () {
        ...
        Route::post('/c3mr/sync/data-all', [C3mrSyncController::class, 'syncDataAll'])->name('c3mr.sync.data-all');
        Route::post('/c3mr/sync/caring', [C3mrSyncController::class, 'syncCaring'])->name('c3mr.sync.caring');
        Route::post('/c3mr/sync/performance', [C3mrSyncController::class, 'syncPerformance'])->name('c3mr.sync.performance');
        Route::post('/c3mr/sync/consolidate-ar', [C3mrSyncController::class, 'consolidateAr'])->name('c3mr.sync.consolidate-ar');
        ...
        // Settings (Spreadsheet PRITI DATA & C3MR Terpusat + Telegram)
        ...
        Route::post('/settings/send-reminders', [SettingController::class, 'sendRemindersNow'])->name('settings.send-reminders');
    });
});