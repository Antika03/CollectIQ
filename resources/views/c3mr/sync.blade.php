...
@section('title', 'C3MR Data Management & Sync')
@section('subtitle', 'Pusat integrasi data Google Spreadsheet C3MR, validasi kualitas data, dan sinkronisasi berkala')
        ...
        <div class="card kpi-card h-100">
            <div>
                ...
                <div style="font-size:11px; color:var(--success); margin-top:4px;">
                    <i class="bi bi-check-circle-fill"></i> {{ number_format($validPhones) }} memiliki No HP valid
                </div>
            </div>
    ...
    <div class="col-6 col-lg-3">
        <div class="card kpi-card h-100">
            <div>
                ...
                <div class="kpi-value">{{ number_format($totalWitel) }}</div>
...
{{-- SPREADSHEET SOURCE & SYNC ACTIONS --}}
<div class="row g-3">
    <div class="col-lg-8">
        <div class="card mb-3">
